      ...
      >
        <Card className="p-3 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 border-green-200 dark:border-green-800">
          <CardContent className="p-0">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-lg font-bold text-green-700 dark:text-green-400">25.5</div>
                <div className="text-xs text-green-600 dark:text-green-400">kg Recycled</div>
              </div>
        ...
        <Card className="p-3 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 border-blue-200 dark:border-blue-800">
          <CardContent className="p-0">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-lg font-bold text-blue-700 dark:text-blue-400">$127.50</div>
                <div className="text-xs text-blue-600 dark:text-blue-400">Total Earned</div>
              </div>
        ...
        <Card className="p-3 bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-950/30 dark:to-violet-950/30 border-purple-200 dark:border-purple-800">
          <CardContent className="p-0">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-lg font-bold text-purple-700 dark:text-purple-400">18</div>
                <div className="text-xs text-purple-600 dark:text-purple-400">Items Processed</div>
              </div>
        ...
        <Card className="p-3 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 border-amber-200 dark:border-amber-800">
          <CardContent className="p-0">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-lg font-bold text-amber-700 dark:text-amber-400">3</div>
                <div className="text-xs text-amber-600 dark:text-amber-400">Pending Pickups</div>
              </div>
