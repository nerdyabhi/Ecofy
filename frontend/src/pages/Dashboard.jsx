      ...
      >
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            ...
            <div className="bg-green-50 dark:bg-green-900/10 border-l-4 border-green-400 dark:border-green-500 pl-4 py-2 rounded-r-lg">
              <p className="text-sm text-green-700 dark:text-green-300 font-medium">
                You're making a real impact building a sustainable future! ✨
              </p>
            </div>
          </div>
          <div className="ml-6 text-center bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl px-4 py-3 border border-green-200 dark:border-green-800 shadow-sm">
      ...
      >
        <Card className="p-3 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 border-green-200 dark:border-green-800">
          <CardContent className="p-0">
            ...
            <div className="text-lg font-bold text-green-700 dark:text-green-400 mb-0.5">
              {ecoPoints.toLocaleString()}
            </div>
            <div className="text-xs text-green-600 dark:text-green-400">Eco Points</div>
          </CardContent>
        </Card>
        ...
        <Card className="p-3 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 border-blue-200 dark:border-blue-800">
          <CardContent className="p-0">
            ...
            <div className="text-lg font-bold text-blue-700 dark:text-blue-400 mb-0.5">
              {carbonScore}kg
            </div>
            <div className="text-xs text-blue-600 dark:text-blue-400">CO₂ Saved</div>
          </CardContent>
        </Card>
        ...
        <Card className="p-3 bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-950/30 dark:to-violet-950/30 border-purple-200 dark:border-purple-800">
          <CardContent className="p-0">
            ...
            <div className="text-lg font-bold text-purple-700 dark:text-purple-400 mb-0.5">
